...
$.jgrid = {
	...
	search : {
	    ...
	    Find: "Procurar",
	    Reset: "Resetar",
	    odata : ['igual a', 'diferente de', 'menor que', 'menor ou igual a','maior que','maior ou igual a', 'começa com','não começa com','está em','não está em','termina com','não termina com','contém','não contém'],
